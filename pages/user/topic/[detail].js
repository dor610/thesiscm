import { Add, Code, Delete, Edit, EditOff, FolderZip } from "@mui/icons-material";
...
import EditTopic from "../../../component/user/topic/EditTopic";
...
const Detail = () =>{
    ...
    const actions = [
        { icon: <Edit />, name: 'Chỉnh sửa đề tài luận văn', onClick: onOpenEdit },
        { icon: <Delete />, name: 'Xoá đề tài luận văn', onClick: deleteTopic },
      ];
    ...
    <Stack direction={"column"} gap={1} sx={{
        ...
        <Grid container width={"100%"} alignItems="center">
            <Grid md={9} lg={10} xl={10.5}>
                <Breadcrumbs aria-label="breadcrumb">
                    ...
                    <Link underline="hover" color="inherit" href="/user/topic">
                    Đề tài luận văn
                    </Link>
        ...
        {topicData? <EditTopic open={openEdit} setOpen={setOpenEdit} data={topicData} />: <></>}
        ...
        <TabContext value={tab} sx={{
            ...
            <TabPanel value="1" sx={{
                ...
                {topicData? topicData.statusCode == "1"? 
                ...
                <SpeedDial
                    ...
                    icon={<SpeedDialIcon />}
                    open={dialOpen}
                    onOpen={e => setDialOpen(true)}
                    onClose={e => setDialOpen(false)}
                >
                    {actions.map((action) => (
                    <SpeedDialAction
                        key={action.name}
                        ...
                        onClick={e => {action.onClick(); setDialOpen(false)}}
                    />
                    ))}
                </SpeedDial>: <></> :<></>}
                </Stack>
